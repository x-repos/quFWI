...
def main(resume_total_steps=0):
    ...
    if resume_total_steps > 0:
        ...
        # Load SPECFEM data
        print("=" * 60)
        print("Step 1: Loading SPECFEM data from checkerboard/event1/")
        print("=" * 60)
    ...
    # Override results path to results/checkerboard/
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Checkerboard FWI on FBPINNs (Quantum-Hybrid)")
